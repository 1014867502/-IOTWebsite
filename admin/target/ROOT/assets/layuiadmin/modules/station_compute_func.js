layui.define(['element', 'form', 'drawer', 'table'], function (exports) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (device != null) {
                    ...
                    if (device != null && device.rtkPos > 0) {
                        rtkturn = true;
            ...
            switch (select) {
                ...
                case "basedownload":
                    document.getElementById(select).innerHTML = "   <div style=\"display: flex;margin-top: 30px\">\n" +
                        ...
                        "                        </div>\n" +
                        "                        <div class=\"layui-form-item\">\n" +
                        "                            <label class=\"layui-form-label\" style='padding: 8px 5px;width: 98px;'>基站①数据来源</label>\n" +
                        "                            <div class=\"layui-input-block\">\n" +
                        "                                <input type=\"radio\" name=\"ntrIpBase\" lay-filter=\"downloadsource\" value=\"0\" title=\"基站文件\" checked>\n" +
                        "                                <input type=\"radio\" name=\"ntrIpBase\" lay-filter=\"downloadsource\" value=\"1\" title=\"CORS数据\">\n" +
                        "                            </div>\n" +
                        "                        </div>\n" +
                        "                        <div id=\"downcontent\">\n" +
                        "                            <div id=\"base\">" +
        ...
        switch (type) {
            ...
            case "1":
                ...
                document.getElementById("XYZ").innerHTML = " <div class=\"layui-form-item  fastinput\">\n" +
                    "                                <label class=\"layui-form-label\">X</label>\n" +
                    "                                <div class=\"layui-input-block\">\n" +
                    "                                    <input id='ecefx' type=\"text\" name=\"ecefx\" lay-verType='tips' lay-verify=\"required\" placeholder=\"请输入X坐标\"\n" +
                    "                                           autocomplete=\"off\" class=\"layui-input\">\n" +
                    "                                </div>\n" +
                    "                            </div>\n" +
                    "                            <div class=\"layui-form-item  fastinput\">\n" +
                    "                                <label class=\"layui-form-label\">Y</label>\n" +
                    "                                <div class=\"layui-input-block\">\n" +
                    "                                    <input id='ecefy' type=\"text\" name=\"ecefy\" lay-verType='tips' lay-verify=\"required\" placeholder=\"请输入Y坐标\"\n" +
                    "                                           autocomplete=\"off\" class=\"layui-input\">\n" +
                    "                                </div>\n" +
                    "                            </div>\n" +
                    "                            <div class=\"layui-form-item  fastinput\">\n" +
                    "                                <label class=\"layui-form-label\">Z</label>\n" +
                    "                                <div class=\"layui-input-block\">\n" +
                    "                                    <input id='ecefz' type=\"text\" name=\"ecefz\" lay-verType='tips' lay-verify=\"required\" placeholder=\"请输入Z坐标\"\n" +
                    "                                           autocomplete=\"off\" class=\"layui-input\">\n" +
                    "                                </div>\n" +
                    "                            </div>";
                break;
    ...
    function mark2compute(lat, lon, height, mark) {
        if (mark == 1) {
            $.ajax({
                url: '/devicelist/blhtoxyz',
                data: {
                ...
                success: function (res) {
                    let data = res.data;
                    try {
                        $("#coordinatesX").val(data.EcefX);
                        $("#coordinatesY").val(data.EcefY);
                        $("#coordinatesZ").val(data.EcefZ);
                        form.render();
                    } catch (err) {
                        //处理错误
                    }
            ...
            $.ajax({
                ...
                success: function (res) {
                    let data = res.data;
                    try {
                        $("#ecefLat").val(data.DesB);
                        $("#ecefLon").val(data.DesL);
                        $("#ecefHeight").val(data.DesH);
                        form.render();
                    } catch (err) {
                        //处理错误
                    }
    ...
    var computefunc = {
        ...
        altermark2: function (mark) {
            changemarkalter(mark);
        },
        ...
        computemark2: function (lat, lon, height, mark) {
            mark2compute(lat, lon, height, mark);
        },
