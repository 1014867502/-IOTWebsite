...
;layui.define("form", function (e) {
    ...
    },b.prototype.qxChecked=function(){
        var that=this;
        that.elem.find('.').each(function (i,item) {
            var thisId=$(this).data('id'),input = $(item).children('.').find('input[same="layuiTreeCheck"]')
                ,reInput = input.next();
          if(input[0].checked){
              reInput.click();
          }
