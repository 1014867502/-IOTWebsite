package com.webmonitor.admin.jna;
...
public class DllInterface {
    ...
    public interface CrxToRnxDLL extends Library{
        public CrxToRnxDLL instance = (CrxToRnxDLL)Native.loadLibrary("crx2rnxDLL64",CrxToRnxDLL.class);

        int CrxToRnx(int argc, String args[]);
